export default function Logo({
  ...
  return (
    ...
    >
      ...
      <rect x="2" y="2" width="116" height="116" rx="16" fill="#FFF0F0" stroke="#4A2C2A" strokeWidth="2.5" />
      ...
      {/* Small star */}
      <circle cx="82" cy="30" r="3" fill="#C9A882" />
      <circle cx="78" cy="24" r="1.5" fill="#C9A882" opacity="0.6" />
