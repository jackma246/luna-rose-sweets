...
const PARTY_SIZES: PartySize[] = [
  {
    ...
    treats: [
      ...
      { name: "Chocolate sandwich cookies (Oreos®️)", maxCount: 3 },
  ...
  },
  {
    ...
    treats: [
      ...
      { name: "Chocolate sandwich cookies (Oreos®️)", maxCount: 4 },
  ...
  },
  {
    ...
    treats: [
      ...
      { name: "Chocolate sandwich cookies (Oreos®️)", maxCount: 8 },
