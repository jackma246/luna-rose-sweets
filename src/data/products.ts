...
export const products: Product[] = [
  // ── Party Sets ──────────────────────────────────────────
  {
    ...
    name: "Party Set",
    category: "Party Sets",
    subtitle: "48 · 60 · 96 · 120 pieces",
    description: "Dessert table party sets for a standard 6ft party table, styled with coordinated chocolate-covered treats and a polished, party-ready finish.",
    details: "6ft Dessert Table Guide\n\nFor a standard 6ft party table, I usually recommend:\n\nMini Dessert Table\n4 dozen treats\nA clean, minimal setup for smaller gatherings.\n\nClassic Dessert Table\n5 dozen treats\nA nicely filled table that still feels simple and elegant.\n\nSignature Dessert Table\n8 dozen treats\nThis gives that full wow, so pretty! dessert table look and photographs beautifully.\n\nLuxe Dessert Table\n10 dozen or more treats\nA fuller luxury style dessert table for larger celebrations.\n\nCake can be added as an optional dessert table centerpiece.",
    variants: [
      { label: "Mini Dessert Table (48 pcs)", price: 175, image: "/images/brand-spread-new.png" },
      { label: "Classic Dessert Table (60 pcs)", price: 215, image: "/images/brand-spread-new.png" },
      { label: "Signature Dessert Table (96 pcs)", price: 310, image: "/images/treat-boxes/party-set-large.jpeg" },
      { label: "Luxe Dessert Table (120 pcs)", price: 395, image: "/images/treat-boxes/party-set-large.jpeg" },
    ],
